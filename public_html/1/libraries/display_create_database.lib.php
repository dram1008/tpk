...
if ($is_create_db_priv) {
    ...
    <form method="post" action="db_create.php" id="create_database_form" class="ajax"><strong>
        ...
        <input type="text" name="new_db" value="<?php echo $db_to_create; ?>" maxlength="64" class="textfield"
               id="text_create_db"/>
        <?php
...
<?php
    ...
    <strong><?php echo __('Create database') . ':&nbsp;' . PMA_Util::showMySQLDocu('SQL-Syntax', 'CREATE_DATABASE'); ?></strong>
    <br/>
    <?php
    echo '<span class="noPrivileges">'
        . PMA_Util::getImage('s_error2.png', '', ['hspace' => 2, 'border' => 0, 'align' => 'middle'])
