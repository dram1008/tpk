    ...
    if ($what == 'replace_prefix_tbl' || $what == 'copy_tbl_change_prefix') {
        ...
        <form action="<?php echo $action; ?>" method="post">
            ...
            <fieldset class="input">
                <legend><?php echo($what == 'replace_prefix_tbl' ? __('Replace table prefix') : __('Copy table with prefix')) ?>
                    :
                </legend>
                <table>
                    <tr>
                        <td><?php echo __('From'); ?></td>
                        <td><input type="text" name="from_prefix" id="initialPrefix"/></td>
                    </tr>
                    <tr>
                        <td><?php echo __('To'); ?> </td>
                        <td><input type="text" name="to_prefix" id="newPrefix"/></td>
                    </tr>
                </table>
            </fieldset>
    ...
    <?php
        ...
        <form action="<?php echo $action; ?>" method="post">
            ...
            <fieldset class="input">
                ...
                <table>
                    <tr>
                        <td><?php echo __('Add prefix'); ?></td>
                        <td><input type="text" name="add_prefix" id="txtPrefix"/></td>
                    </tr>
                </table>
            </fieldset>
            <fieldset class="tblFooters">
        ...
        <fieldset class="tblFooters">
            <form action="<?php echo $action; ?>" method="post">
                ...
                <span class="checkbox"><input type="checkbox" name="fk_check" value="1" id="fkc_checkbox"<?php
                    ...
                    <span id="fkc_status"
                          class="fkc_switch"><?php echo ($default_fk_check_value) ? __('(Enabled)') : __('(Disabled)'); ?></span>
                    </div><?php
                } ?>
                <input type="hidden" name="mult_btn" value="<?php echo __('Yes'); ?>"/>
